...
//  Generated date: Fri Mar 11 16:16:41 2016
// ----------------------------------------------------------------------
          ...
          forever begin : main
            ...
            begin : ACC1Exit
              forever begin : ACC1
                ...
                ACC1_acc_71_itm = conv_u2u_16_17(signext_16_12(~ (conv_u2s_10_12({(ACC1_acc_21_psp_sva[11])
                    ...
                    , 1'b0 , (ACC1_acc_21_psp_sva[6]) , (acc_imod_1_sva[1])}))))
                    ...
                    + conv_u2u_16_17(signext_16_12(~ (conv_u2s_10_12({(ACC1_acc_22_psp_sva[11])
                    ...
                    + conv_u2u_8_9(readslicef_9_8_1((({(ACC1_acc_22_psp_sva[9]) ,
                    1'b0 , (ACC1_acc_22_psp_sva[9]) , 1'b0 , (ACC1_acc_22_psp_sva[9])
                    , 1'b0 , (signext_2_1(ACC1_acc_22_psp_sva[5])) , 1'b1}) + conv_u2u_8_9({(readslicef_8_7_1((conv_u2u_7_8({(ACC1_acc_22_psp_sva[7])
                    ...
                    , 1'b0 , (ACC1_acc_22_psp_sva[6]) , (acc_imod_4_sva[1])}))))
                    , (~ (readslicef_3_1_2((({1'b1 , (acc_imod_4_sva[0]) , 1'b1})
                    + conv_u2s_2_3({(~ (acc_imod_4_sva[1])) , (~ (acc_imod_4_sva[2]))})))))})))))})
                    + conv_s2s_10_12(conv_u2s_9_10({(ACC1_acc_22_psp_sva[10]) , 1'b0
                    , (ACC1_acc_22_psp_sva[10]) , 1'b0 , (ACC1_acc_22_psp_sva[10])
                    , 1'b0 , (ACC1_acc_22_psp_sva[10]) , 1'b0 , (ACC1_acc_22_psp_sva[10])})
                    + conv_s2s_8_10(readslicef_9_8_1((conv_u2s_8_9({(ACC1_acc_22_psp_sva[8])
                    , 1'b0 , (ACC1_acc_22_psp_sva[8]) , 1'b0 , (ACC1_acc_22_psp_sva[8])
                    , 1'b0 , (ACC1_acc_22_psp_sva[8]) , 1'b1}) + conv_s2s_7_9({(readslicef_7_6_1((conv_s2s_5_7({(readslicef_5_4_1((conv_s2s_4_5({(readslicef_4_3_1((conv_u2s_3_4({(ACC1_acc_22_psp_sva[3])
                    ...
                    , (ACC1_acc_22_psp_sva[4]) , (signext_2_1(ACC1_acc_22_psp_sva[11]))
                    , (acc_5_psp_sva[1])})))) , (~ (acc_imod_4_sva[2]))}))))))));
                ACC1_acc_70_itm = conv_u2u_16_17(signext_16_12(~ (conv_u2s_10_12({(ACC1_acc_24_psp_sva[11])
                    ...
                    + conv_u2u_8_9(readslicef_9_8_1((({(ACC1_acc_24_psp_sva[9]) ,
                    1'b0 , (ACC1_acc_24_psp_sva[9]) , 1'b0 , (ACC1_acc_24_psp_sva[9])
                    , 1'b0 , (signext_2_1(ACC1_acc_24_psp_sva[5])) , 1'b1}) + conv_u2u_8_9({(readslicef_8_7_1((conv_u2u_7_8({(ACC1_acc_24_psp_sva[7])
                    ...
                    , 1'b0 , (ACC1_acc_24_psp_sva[6]) , (acc_imod_10_sva[1])}))))
                    , (~ (readslicef_3_1_2((({1'b1 , (acc_imod_10_sva[0]) , 1'b1})
                    + conv_u2s_2_3({(~ (acc_imod_10_sva[1])) , (~ (acc_imod_10_sva[2]))})))))})))))})
                    + conv_s2s_10_12(conv_u2s_9_10({(ACC1_acc_24_psp_sva[10]) , 1'b0
                    , (ACC1_acc_24_psp_sva[10]) , 1'b0 , (ACC1_acc_24_psp_sva[10])
                    , 1'b0 , (ACC1_acc_24_psp_sva[10]) , 1'b0 , (ACC1_acc_24_psp_sva[10])})
                    + conv_s2s_8_10(readslicef_9_8_1((conv_u2s_8_9({(ACC1_acc_24_psp_sva[8])
                    , 1'b0 , (ACC1_acc_24_psp_sva[8]) , 1'b0 , (ACC1_acc_24_psp_sva[8])
                    , 1'b0 , (ACC1_acc_24_psp_sva[8]) , 1'b1}) + conv_s2s_7_9({(readslicef_7_6_1((conv_s2s_5_7({(readslicef_5_4_1((conv_s2s_4_5({(readslicef_4_3_1((conv_u2s_3_4({(ACC1_acc_24_psp_sva[3])
                    ...
                    , (ACC1_acc_24_psp_sva[4]) , (signext_2_1(ACC1_acc_24_psp_sva[11]))
                    , (acc_13_psp_sva[1])})))) , (~ (acc_imod_10_sva[2]))}))))))))
                    + conv_u2u_16_17(signext_16_12(~ (conv_u2s_10_12({(ACC1_acc_25_psp_sva[11])
                    ...
                    + conv_u2u_8_9(readslicef_9_8_1((({(ACC1_acc_25_psp_sva[9]) ,
                    1'b0 , (ACC1_acc_25_psp_sva[9]) , 1'b0 , (ACC1_acc_25_psp_sva[9])
                    , 1'b0 , (signext_2_1(ACC1_acc_25_psp_sva[5])) , 1'b1}) + conv_u2u_8_9({(readslicef_8_7_1((conv_u2u_7_8({(ACC1_acc_25_psp_sva[7])
                    ...
                    , 1'b0 , (ACC1_acc_25_psp_sva[6]) , (acc_imod_13_sva[1])}))))
                    , (~ (readslicef_3_1_2((({1'b1 , (acc_imod_13_sva[0]) , 1'b1})
                    + conv_u2s_2_3({(~ (acc_imod_13_sva[1])) , (~ (acc_imod_13_sva[2]))})))))})))))})
                    + conv_s2s_10_12(conv_u2s_9_10({(ACC1_acc_25_psp_sva[10]) , 1'b0
                    , (ACC1_acc_25_psp_sva[10]) , 1'b0 , (ACC1_acc_25_psp_sva[10])
                    , 1'b0 , (ACC1_acc_25_psp_sva[10]) , 1'b0 , (ACC1_acc_25_psp_sva[10])})
                    + conv_s2s_8_10(readslicef_9_8_1((conv_u2s_8_9({(ACC1_acc_25_psp_sva[8])
                    , 1'b0 , (ACC1_acc_25_psp_sva[8]) , 1'b0 , (ACC1_acc_25_psp_sva[8])
                    , 1'b0 , (ACC1_acc_25_psp_sva[8]) , 1'b1}) + conv_s2s_7_9({(readslicef_7_6_1((conv_s2s_5_7({(readslicef_5_4_1((conv_s2s_4_5({(readslicef_4_3_1((conv_u2s_3_4({(ACC1_acc_25_psp_sva[3])
                    ...
                    , (ACC1_acc_25_psp_sva[4]) , (signext_2_1(ACC1_acc_25_psp_sva[11]))
                ...
                ACC1_acc_72_sdt = conv_u2u_17_18(ACC1_acc_71_itm) + conv_u2u_17_18(ACC1_acc_70_itm);
                grey_1_sva_1 = (conv_u2s_42_21(conv_u2s_16_21({{4{ACC1_acc_28_itm[11]}},
                    ACC1_acc_28_itm}) * conv_s2s_6_21({or_seb_sva , 2'b11 , ({{2{or_seb_sva}},
                    or_seb_sva})})) + conv_s2s_19_21({(conv_u2u_16_17(ACC1_acc_72_sdt[17:2])
                    + 17'b10000000000000001) , (ACC1_acc_72_sdt[1:0])})) + grey_1_sva;
                if ( ~ ACC1_slc_itm )
                  disable ACC1Exit;
