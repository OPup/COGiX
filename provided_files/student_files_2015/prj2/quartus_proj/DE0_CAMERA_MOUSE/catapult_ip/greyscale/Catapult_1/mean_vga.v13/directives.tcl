...
//  
project new
solution file add {../../../../catapult_proj/vga_blur/blur.h} -type CHEADER
solution file add {../../../../catapult_proj/vga_blur/bmp_io.cpp} -type C++
solution file add {../../../../catapult_proj/vga_blur/shift_class.h} -type CHEADER
solution file add {../../../../catapult_proj/vga_blur/tb_blur.cpp} -type C++
solution file add {../../../../catapult_proj/vga_blur/bmp_io.h} -type CHEADER
solution file add {../../../../catapult_proj/vga_blur/blur.c} -type C++
...
directive set -DESIGN_HIERARCHY mean_vga__FP33ac_int__tm__19_XCiL_3_150XCbL_1_0P32ac_int__tm__18_XCiL_2_30XCbL_1_0
go compile
directive set /mean_vga/core -DESIGN_GOAL latency
directive set /mean_vga/core/ACC1 -UNROLL yes
directive set /mean_vga/core/SHIFT -UNROLL yes
directive set /mean_vga/core/for:for -UNROLL yes
directive set /mean_vga/core/for -UNROLL yes
