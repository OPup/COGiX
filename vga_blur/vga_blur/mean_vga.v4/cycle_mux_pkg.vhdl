...
--  Generated date: Tue Mar 08 14:42:23 2016
-- ----------------------------------------------------------------------
...
PACKAGE mean_vga_mux_pkg IS 
  FUNCTION MUX_v_30_8_2(inputs : STD_LOGIC_VECTOR(239 DOWNTO 0); sel : STD_LOGIC_VECTOR(2
      DOWNTO 0))
...
RETURN STD_LOGIC_VECTOR IS
  VARIABLE or_inputs : STD_LOGIC_VECTOR(239 DOWNTO 0);
  ...
  BEGIN
    CASE sel IS
      ...
      WHEN "101" =>
        result := inputs(89 DOWNTO 60);
      WHEN "100" =>
        result := inputs(119 DOWNTO 90);
      WHEN "011" =>
        result := inputs(149 DOWNTO 120);
      WHEN "010" =>
        result := inputs(179 DOWNTO 150);
      WHEN "001" =>
        result := inputs(209 DOWNTO 180);
      WHEN "000" =>
        result := inputs(239 DOWNTO 210);
      WHEN others =>
        result := (others => '0');
