...
# Generated date: Tue Mar 01 15:07:49 +0000 2016
#
# ----------------------------------------------------------------------------
# ===================================================
...
RTL_NETLIST_FNAME           = H:/CatapultCLab/COGiX/dot_product/dot_product/dot_product.v4/rtl.v
endif
...
TOP_DU                   += scverify_top
CXX_TYPE                 += gcc
MSIM_SCRIPT              += ./dot_product/dot_product.v4/scverify_msim.tcl
...
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = ./gate.v/gate.v.vts
endif
endif
...
VHDL_SRC = 
VLOG_SRC = ./gate.v/gate.v.vts
endif
CXX_SRC  = ../../dot_product.cpp/dot_product.cpp.cxxts ../../tb_dot_product.cpp/tb_dot_product.cpp.cxxts ./scverify/mc_testbench.cpp/mc_testbench.cpp.cxxts ./scverify/scverify_top.cpp/scverify_top.cpp.cxxts ./top_gate_constraints.cpp/top_gate_constraints.cpp.cxxts
# Specify RTL synthesis scripts (if any)
RTL_SCRIPT = ./scverify/gate.psrv
...
$(TARGET)/gate.v.vts: ./gate.v
$(TARGET)/dot_product.cpp.cxxts: ../../dot_product.cpp
$(TARGET)/tb_dot_product.cpp.cxxts: ../../tb_dot_product.cpp
$(TARGET)/mc_testbench.cpp.cxxts: ./scverify/mc_testbench.cpp
$(TARGET)/scverify_top.cpp.cxxts: ./scverify/scverify_top.cpp
$(TARGET)/top_gate_constraints.cpp.cxxts: ./top_gate_constraints.cpp
# 
