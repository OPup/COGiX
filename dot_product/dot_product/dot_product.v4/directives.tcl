...
//  
//  Running on Windows 7 kjr115@EEWS104A-008 Service Pack 1 6.01.7601 i686
//  
...
solution file add {./dot_product.cpp} -type C++
solution file add {./dot_product.h} -type CHEADER
solution file add {./tb_dot_product.cpp} -type C++
